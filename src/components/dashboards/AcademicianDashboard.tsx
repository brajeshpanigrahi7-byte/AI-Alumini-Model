...
export const AcademicianDashboard: React.FC<AcademicianDashboardProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      {/* Student Milestone Verification Queue */}
      <div className="bg-[#F9F9F7] rounded-2xl border border-[#E5E2D9] p-6 shadow-xs space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E5E2D9] pb-4">
          <div>
            <h2 className="text-lg font-bold text-[#2D2D2A] font-serif-display flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-[#7A6A32]" />
              <span>Student Skill & Project Cryptographic Verification Queue</span>
            </h2>
          ...
          <span className="text-xs font-bold bg-[#F7F3E8] text-[#7A6A32] border border-[#E9E0C7] px-3 py-1 rounded-lg">
      ...
      {/* Curriculum Alignment & Research Collaboration */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[#F9F9F7] rounded-2xl border border-[#E5E2D9] p-6 shadow-xs space-y-4">
          <div className="flex items-center justify-between border-b border-[#E5E2D9] pb-3">
            <h3 className="text-base font-bold text-[#2D2D2A] font-serif-display flex items-center gap-2">
              <BookOpen className="w-4 h-4 text-[#7A6A32]" />
              <span>Curriculum Industry Benchmark Alignment</span>
            </h3>
            <span className="text-xs font-bold text-[#34583A] bg-[#EAF1EB] px-2 py-0.5 rounded">94% Aligned</span>
          </div>
        ...
        <div className="bg-[#F9F9F7] rounded-2xl border border-[#E5E2D9] p-6 shadow-xs space-y-4">
          <div className="flex items-center justify-between border-b border-[#E5E2D9] pb-3">
            <h3 className="text-base font-bold text-[#2D2D2A] font-serif-display flex items-center gap-2">
              <DollarSign className="w-4 h-4 text-[#34583A]" />
